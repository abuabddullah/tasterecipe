        ...
        <div className="p-8 bg-white shadow mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="space-x-8 flex justify-between mt-32 md:mt-0 md:justify-center">
              <button onClick={()=>navigate(`/dashboard/editProfile/${userData._id}`)} className="text-white py-2 px-4 uppercase rounded bg-blue-400 hover:bg-blue-500 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5">
                {" "}
                Edit Profile
              </button>{" "}
